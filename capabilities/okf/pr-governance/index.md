...
# Guarded pull-request capability graph

* [Inspect Git repository](inspect_git_repository.md) - Inspect immutable repository state.
* [Inspect pull request](inspect_pull_request.md) - Inspect a diff at an exact head SHA.
