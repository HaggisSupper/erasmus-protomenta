...
class TestMigrations:
    ...
    def test_migration_idempotent_on_existing_db(self, tmp_path):
        ...
        assert count == 14  # exactly fourteen migrations recorded
    ...
    def test_real_premission01_upgrade(self, tmp_path):
        ...
        # Schema-version auditability: every version is recorded exactly once.
        ...
        assert count == 14  # still exactly fourteen, not duplicated
...
class TestRecovery:
    ...
    def test_migrations_reapplied_correctly_on_existing_db_after_restart(
        ...
        assert count == 14  # exactly fourteen migrations recorded, not duplicated
