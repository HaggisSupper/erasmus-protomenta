...
class TestMigrations:
    ...
    def test_migration_idempotent_on_existing_db(self, tmp_path):
        ...
        assert count == 11  # exactly eleven migrations recorded
    ...
    def test_real_premission01_upgrade(self, tmp_path):
        ...
        assert count == 11  # still exactly eleven, not duplicated
...
class TestRecovery:
    ...
    def test_migrations_reapplied_correctly_on_existing_db_after_restart(
        ...
        assert count == 11  # exactly eleven migrations recorded, not duplicated
